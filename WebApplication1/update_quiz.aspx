<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="update_quiz.aspx.cs" Inherits="WebApplication1.update_quiz" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <label for="validationServer01"> Short answer details </label>
      ...
      <div class="valid-feedback">
        quiz title
                         ...
                         <div class="col-md-3 mb-3">
      <label for="validationServer01"> Mark of each true/false</label>
